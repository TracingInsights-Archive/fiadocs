...
class API:
    ...
    def get_retweeter_ids(self, id, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("id", "count", "cursor", "stringify_ids"),
            id=id,
            **kwargs,
        )
    ...
    def get_retweets(self, id, **kwargs):
        ...
        return self.request(
            "GET",
            f"statuses/retweets/{id}",
            endpoint_parameters=("count", "trim_user"),
            **kwargs,
        )
    ...
    def create_favorite(self, id, **kwargs):
        ...
        return self.request(
            "POST",
            "favorites/create",
            endpoint_parameters=("id", "include_entities"),
            id=id,
            **kwargs,
        )
    ...
    def destroy_status(self, id, **kwargs):
        ...
        return self.request(
            "POST",
            f"statuses/destroy/{id}",
            endpoint_parameters=("trim_user",),
            **kwargs,
        )
    ...
    @payload("status")
    def update_status_with_media(self, status, filename, *, file=None, **kwargs):
    ...
    def get_lists(self, **kwargs):
        ...
        return self.request(
            "GET",
            "lists/list",
            endpoint_parameters=("user_id", "screen_name", "reverse"),
            **kwargs,
        )
    ...
    def get_list_ownerships(self, **kwargs):
        ...
        return self.request(
            "GET",
            "lists/ownerships",
            endpoint_parameters=("user_id", "screen_name", "count", "cursor"),
            **kwargs,
        )
    ...
    def get_list(self, **kwargs):
        ...
        return self.request(
            "GET",
            "lists/show",
            endpoint_parameters=("list_id", "slug", "owner_screen_name", "owner_id"),
            **kwargs,
        )
    ...
    def create_list(self, name, **kwargs):
        ...
        return self.request(
            "POST",
            "lists/create",
            endpoint_parameters=("name", "mode", "description"),
            name=name,
            **kwargs,
        )
    ...
    def destroy_list(self, **kwargs):
        ...
        return self.request(
            "POST",
            "lists/destroy",
            endpoint_parameters=("owner_screen_name", "owner_id", "list_id", "slug"),
            **kwargs,
        )
    ...
    def incoming_friendships(self, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("cursor", "stringify_ids"),
            **kwargs,
        )
    ...
    def lookup_friendships(self, *, screen_name=None, user_id=None, **kwargs):
        ...
        return self.request(
            "GET",
            "friendships/lookup",
            endpoint_parameters=("screen_name", "user_id"),
            screen_name=list_to_csv(screen_name),
            user_id=list_to_csv(user_id),
            **kwargs,
        )
    ...
    def no_retweets_friendships(self, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("stringify_ids",),
            **kwargs,
        )
    ...
    def search_users(self, q, **kwargs):
        ...
        return self.request(
            "GET",
            "users/search",
            endpoint_parameters=("q", "page", "count", "include_entities"),
            q=q,
            **kwargs,
        )
    ...
    def get_user(self, **kwargs):
        ...
        return self.request(
            "GET",
            "users/show",
            endpoint_parameters=("user_id", "screen_name", "include_entities"),
            **kwargs,
        )
    ...
    def create_friendship(self, **kwargs):
        ...
        return self.request(
            "POST",
            "friendships/create",
            endpoint_parameters=("screen_name", "user_id", "follow"),
            **kwargs,
        )
    ...
    def update_friendship(self, **kwargs):
        ...
        return self.request(
            "POST",
            "friendships/update",
            endpoint_parameters=("screen_name", "user_id", "device", "retweets"),
            **kwargs,
        )
    ...
    def get_settings(self, **kwargs):
        ...
        """
        return self.request("GET", "account/settings", use_cache=False, **kwargs)
    ...
    def verify_credentials(self, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("include_entities", "skip_status", "include_email"),
            **kwargs,
        )
    ...
    def get_profile_banner(self, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("user_id", "screen_name"),
            **kwargs,
        )
    ...
    def update_profile_banner(self, filename, *, file=None, **kwargs):
        ...
        with contextlib.ExitStack() as stack:
            ...
            return self.request(
                ...
                endpoint_parameters=("width", "height", "offset_left", "offset_top"),
                files=files,
                **kwargs,
            )
    ...
    def update_profile_image(self, filename, *, file=None, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("include_entities", "skip_status"),
            files=files,
            **kwargs,
        )
    ...
    def get_blocks(self, **kwargs):
        ...
        return self.request(
            "GET",
            "blocks/list",
            endpoint_parameters=("include_entities", "skip_status", "cursor"),
            **kwargs,
        )
    ...
    def get_muted_ids(self, **kwargs):
        ...
        return self.request(
            "GET",
            "mutes/users/ids",
            endpoint_parameters=("stringify_ids", "cursor"),
            **kwargs,
        )
    ...
    def get_mutes(self, **kwargs):
        ...
        return self.request(
            "GET",
            "mutes/users/list",
            endpoint_parameters=("cursor", "include_entities", "skip_status"),
            **kwargs,
        )
    ...
    def report_spam(self, **kwargs):
        ...
        return self.request(
            "POST",
            "users/report_spam",
            endpoint_parameters=("screen_name", "user_id", "perform_block"),
            **kwargs,
        )
    ...
    def get_direct_messages(self, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("count", "cursor"),
            **kwargs,
        )
    ...
    def send_direct_message(
        ...
        **kwargs,
        ...
        return self.request(
            "POST", "direct_messages/events/new", json_payload=json_payload, **kwargs
        )
    ...
    def indicate_direct_message_typing(self, recipient_id, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("recipient_id",),
            recipient_id=recipient_id,
            **kwargs,
        )

    def mark_direct_message_read(self, last_read_event_id, recipient_id, **kwargs):
        ...
        return self.request(
            ...
            endpoint_parameters=("last_read_event_id", "recipient_id"),
    ...
    def get_media_upload_status(self, media_id, **kwargs):
        ...
        return self.request(
            "GET",
            "/2/media/upload",
            endpoint_parameters=("command", "media_id"),
            command="STATUS",
            media_id=media_id,
            **kwargs,
        )
    ...
    def create_media_metadata(self, media_id, alt_text, **kwargs):
        ...
        """
        json_payload = {"id": media_id, "metadata": {"alt_text": {"text": alt_text}}}

        return self.request(
            "POST", "/2/media/metadata", json_payload=json_payload, **kwargs
        )
    ...
    def simple_upload(
        ...
        **kwargs,
        ...
        with contextlib.ExitStack() as stack:
            ...
            media = self.request(
                "POST", "/2/media/upload", post_data=post_data, files=files, **kwargs
            )
            media.media_id = int(media.id)  # Backwards-compatibility with v1.1
            media.media_id_string = media.id
            return media
    ...
    def chunked_upload(
        ...
        **kwargs,
        ...
        # Use 5MB as default chunk size
        chunk_size = kwargs.pop("chunk_size", 5000000)
        # Max chunk size is a bit less than 5MiB so we do 5MB to be safe
        chunk_size = max(min(chunk_size, 5000000), min_chunk_size)
        ...
        if wait_for_async_finalize and "processing_info" in media.data:
            while (
                media.data["processing_info"]["state"] in ("pending", "in_progress")
                and "error" not in media.data["processing_info"]["state"]
            ):
                time.sleep(media.data["processing_info"]["check_after_secs"])
                media = self.get_media_upload_status(media.data["id"], **kwargs)

        media.media_id = int(media.data["id"])  # Backwards-compatibility with v1.1
        media.media_id_string = media.data["id"]
        return media
    ...
    def chunked_upload_finalize(self, media_id, **kwargs):
        ...
        """
        return self.request("POST", f"/2/media/upload/{media_id}/finalize", **kwargs)
    ...
    def chunked_upload_init(
        ...
        **kwargs,
        ...
        if media_category is not None:
            json_payload["media_category"] = media_category
        if additional_owners is not None:
            json_payload["additional_owners"] = list_to_csv(additional_owners)

        return self.request(
            "POST", "/2/media/upload/initialize", json_payload=json_payload, **kwargs
        )
    ...
    def get_place_trends(self, id, **kwargs):
        ...
        return self.request(
            "GET",
            "trends/place",
            endpoint_parameters=("id", "exclude"),
            id=id,
            **kwargs,
        )
